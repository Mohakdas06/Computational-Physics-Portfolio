...
plot "data_25/Final.dat" using 1:2:(s*$3):(s*$4) with vectors head filled lw 1.5 lc rgb "#DC143C" title "Velocity Vectors", \
    "data_25/Final.dat" using 1:2 with points pt 7 ps 1.5 lc rgb "#483D8B" title "Particles"
