...
set output 'plots/prob02_sampling.pdf'
...
plot f(x) w l lw 3 lc 'black' notitle, \
     'data/prob02_sampling.dat' using 1:2:3 with points pt 7 ps 0.4 lc variable notitle
reset

# ============================================================================
set terminal pdfcairo enhanced font "CMU Serif,16" size 8,6
set output "plots/prob02_error.pdf"
...
set fit quiet
fit f_log(x) "data/prob02_error.dat" using (log10($1)):(log10($2)) via A, b
...
plot 'data/prob02_error.dat' using 1:2 with points pt 7 ps 0.8 lw 2 lc rgb "royalblue" title "Actual Error", \
