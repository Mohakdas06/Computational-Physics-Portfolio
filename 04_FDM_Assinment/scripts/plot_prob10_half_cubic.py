...
DATA = np.loadtxt("data/prob10.dat")
ENERGIES = np.loadtxt("data/prob10_energies.dat")
SCALE_FACTOR = 30
...
plt.plot(x, V_x, color='black', linewidth=2, label=r'V(x) = $x^3$ for $x \geq 0$')
...
plt.title('Half Cubic Potential Solutions (FDM)', size=15)
...
plt.savefig('plots/prob10_half_cubic.png', dpi=300)
plt.show()