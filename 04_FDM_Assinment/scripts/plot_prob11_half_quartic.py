...
DATA = np.loadtxt("data/prob11.dat")
ENERGIES = np.loadtxt("data/prob11_energies.dat")
SCALE_FACTOR = 30
...
plt.plot(x, V_x, color='black', linewidth=2, label=r'V(x) = $x^4$ for $x \geq 0$')
...
plt.title('Half Quartic Potential Solutions (FDM)', size=15)
...
plt.savefig('plots/prob11_half_quartic.png', dpi=300)
plt.show()